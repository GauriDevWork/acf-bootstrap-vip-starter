jQuery(document).ready(function ($) {
    ...
    jQuery(window).scroll(function () {
        ...
        if (jQuery('.{{THEME_PREFIX}}-counter-sec').length > 0) {
            var oTop = jQuery('.{{THEME_PREFIX}}-counter-sec').offset().top - window.innerHeight;
    ...
    var findUsSlider = jQuery('.{{THEME_PREFIX}}-find-us-slider');
    ...
    var clientSlider = jQuery('.{{THEME_PREFIX}}-client-slider');
    ...
    var physiciansSlider = jQuery('.{{THEME_PREFIX}}-physicians-slider');
    ...
    var physiciansSlider = jQuery('.{{THEME_PREFIX}}-related-slider');
    var physiciansSlideCount = physiciansSlider.children().length;
    ...
    var rpSlider = jQuery('.{{THEME_PREFIX}}-rp-slider');
    ...
    jQuery('.{{THEME_PREFIX}}-footer .copyright-text a').each(function () {
