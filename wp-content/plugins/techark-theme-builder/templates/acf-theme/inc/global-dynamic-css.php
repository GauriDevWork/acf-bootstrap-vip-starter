 ...
 * Convert HEX to RGBA
 */
function {{THEME_PREFIX}}hex2rgba($color, $opacity = 1)
{
...
// Final RGBA
$header_rgba = {{THEME_PREFIX}}hex2rgba($header_background_color, $header_opacity);
...
$footer_overlay_bg = {{THEME_PREFIX}}hex2rgba($footer_bg['background-color'], 0.8);
...
<style type="text/css" id="global-dynamic-css">
    ...
    ?>@media(min-width:1400px) {
        .custom-container .{{THEME_PREFIX}}-find-us-slider {
    ...
    <?php endif; ?>.{{THEME_PREFIX}}-footer .ft-top-row {
    ...
    input[type=reset],
    input[type=button],
    .{{THEME_PREFIX}}-footer .footer-col .wp-block-button .wp-element-button {
