...
if ( ! function_exists( '{{THEME_PREFIX_LONG}}posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function {{THEME_PREFIX_LONG}}posted_on() {
...
if ( ! function_exists( '{{THEME_PREFIX_LONG}}posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function {{THEME_PREFIX_LONG}}posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( '{{THEME_PREFIX_LONG}}entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function {{THEME_PREFIX_LONG}}entry_footer() {
...
if ( ! function_exists( '{{THEME_PREFIX_LONG}}post_thumbnail' ) ) :
	/**
	 ...
	 */
	function {{THEME_PREFIX_LONG}}post_thumbnail() {
