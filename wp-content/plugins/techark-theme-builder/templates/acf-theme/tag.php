...
$layout = !empty($options['tag_post_layout']) ? $options['tag_post_layout'] : 'grid';
	...
	<section class="{{THEME_PREFIX}}-blog py-75">
		<div class="container">
			<div class="{{THEME_PREFIX}}-blog-row">
				<?php
				if ($options['tag_sidebar_position'] == 'left-sidebar') {
				?>
				...
				?>
					<div class="{{THEME_PREFIX}}-blog-card-wrapper">
						<div class="{{THEME_PREFIX}}-blog-card-row <?php echo $class;  ?>">
							...
							?>
								<a class="{{THEME_PREFIX}}-blog-card" href="<?php echo get_permalink($post_id); ?>">
									<div class="img-block">
										<?php
										echo getlazyload_img($image_arr, '100', '100');
										if ($options['enable_date_tag']) {
										?>
				...
				if ($options['tag_sidebar_position'] == 'right-sidebar') {
				?>
					<div class="{{THEME_PREFIX}}-blog-sidebar">
						<?php
						if (is_active_sidebar('blog-sidebar')):
				...
				if ($options['tag_sidebar_position'] == 'no-sidebar' && $class == 'list-view') {
				?>
