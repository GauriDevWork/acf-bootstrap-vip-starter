...
<main id="main-content" class="site-main">
	...
	if ($banner_enable) :
	?>
		<section class="{{TEXT_DOMAIN}}-banner py-75" style="<?php echo esc_attr($banner_style); ?>">
	...
	<section class="error-404 not-found py-75">
		<div class="<?php echo esc_attr({{THEME_PREFIX}}get_container_class()); ?>">
			...
			if (!empty($btn_text)) :
			?>
				<a href="<?php echo esc_url($btn_url); ?>" target="<?php echo esc_attr($btn_target); ?>" class="{{TEXT_DOMAIN}}-btn wow fadeInUp">
