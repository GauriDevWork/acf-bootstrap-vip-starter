jQuery(document).ready(function ($) {
    ...
    jQuery(window).scroll(function () {
        ...
        if (jQuery('.{{TEXT_DOMAIN}}-counter-sec').length > 0) {
            var oTop = jQuery('.{{TEXT_DOMAIN}}-counter-sec').offset().top - window.innerHeight;
    ...
    var findUsSlider = jQuery('.{{TEXT_DOMAIN}}-find-us-slider');
    ...
    var clientSlider = jQuery('.{{TEXT_DOMAIN}}-client-slider');
    ...
    var physiciansSlider = jQuery('.{{TEXT_DOMAIN}}-physicians-slider');
    ...
    var physiciansSlider = jQuery('.{{TEXT_DOMAIN}}-related-slider');
    var physiciansSlideCount = physiciansSlider.children().length;
    ...
    var rpSlider = jQuery('.{{TEXT_DOMAIN}}-rp-slider');
    ...
    jQuery('.{{TEXT_DOMAIN}}-footer .copyright-text a').each(function () {
