 ...
 */
function {{THEME_PREFIX}}customize_register($wp_customize)
{
	...
	if (isset($wp_customize->selective_refresh)) {
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => '{{THEME_PREFIX}}customize_partial_blogname',
			)
		);
		$wp_customize->selective_refresh->add_partial(
			'blogdescription',
			array(
				...
				'render_callback' => '{{THEME_PREFIX}}customize_partial_blogdescription',
			)
		);
	}
}
add_action('customize_register', '{{THEME_PREFIX}}customize_register');
 ...
 * @return void
 */
function {{THEME_PREFIX}}customize_partial_blogname()
{
	bloginfo('name');
}
 ...
 * @return void
 */
function {{THEME_PREFIX}}customize_partial_blogdescription()
{
 ...
 */
function {{THEME_PREFIX}}customize_preview_js()
{
	wp_enqueue_script('{{THEME_SLUG}}-customizer', get_stylesheet_directory_uri() . '/assets/js/customizer.js', array('customize-preview'), _S_VERSION, true);
}
add_action('customize_preview_init', '{{THEME_PREFIX}}customize_preview_js');
