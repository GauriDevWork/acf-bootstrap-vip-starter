...
<style type="text/css" id="global-dynamic-css">
    ...
    ?>@media(min-width:1400px) {
        .custom-container .{{TEXT_DOMAIN}}-find-us-slider {
    ...
    <?php endif; ?>.{{TEXT_DOMAIN}}-footer .ft-top-row {
    ...
    input[type=reset],
    input[type=button],
    .{{TEXT_DOMAIN}}-footer .footer-col .wp-block-button .wp-element-button {
