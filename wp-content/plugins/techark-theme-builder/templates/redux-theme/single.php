...
<main id="main-content" class="site-main">
  ...
  <div class="<?php echo esc_attr({{THEME_PREFIX}}get_container_class()); ?>  py-75">
    <div class="{{TEXT_DOMAIN}}-blog-row blog-detail">
      <?php
      ...
      <div class="{{TEXT_DOMAIN}}-blog-card-wrapper">
        <div class="{{TEXT_DOMAIN}}-blog-card-row">
          <?php
  ...
  ?>
      <section class="{{TEXT_DOMAIN}}-rp py-75">
        <div class="<?php echo esc_attr({{THEME_PREFIX}}get_container_class()); ?>">
          ...
          ?>
          <div class="{{TEXT_DOMAIN}}-rp-slider-wrapper">
            <div class="{{TEXT_DOMAIN}}-rp-slider owl-carousel owl-theme" post_count="<?php echo $post_count; ?>">
              <?php
