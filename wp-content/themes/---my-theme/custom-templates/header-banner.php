...
if ($banner_enable) {
    ...
    ?>
    <section class="my-theme-banner my-75 custom-lazystyle" style="<?php echo esc_attr($banner_style); ?>" data-style="<?php echo $banner_bg_image; ?>">
    ...
    if (is_singular('post')) {
        ?>
        <section class="my-theme-banner my-75" style="<?php echo esc_attr($banner_style); ?>">
            <div class="<?php echo esc_attr(my_theme_get_container_class()); ?>">
                <h1 class="h1" style="text-align:<?php echo esc_attr($banner_title_align); ?>;">
