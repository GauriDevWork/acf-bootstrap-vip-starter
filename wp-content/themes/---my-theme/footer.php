...
$footer_fullwidth = $options['footer_fullwidth'] == 1 ? 'container-fluid' : esc_attr(my_theme_get_container_class());
...
?>
<footer class="my-theme-footer mt-75" style="<?php echo esc_attr($footer_style); ?>">
