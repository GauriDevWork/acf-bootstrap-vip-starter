...
<main id="main-content" class="site-main">
  ...
  ?>
  <div class="<?php echo esc_attr(my_theme_get_container_class()); ?>  py-75">
    <div class="my-theme-blog-row blog-detail">
      <?php
      ...
      <div class="my-theme-blog-card-wrapper">
        <div class="my-theme-blog-card-row">
          <?php
  ...
  ?>
      <section class="my-theme-rp py-75">
        <div class="<?php echo esc_attr(my_theme_get_container_class()); ?>">
          ...
          ?>
          <div class="my-theme-rp-slider-wrapper">
            <div class="my-theme-rp-slider owl-carousel owl-theme" post_count="<?php echo $post_count; ?>">
              <?php
              while ($related_query->have_posts()):
                $related_query->the_post();
                $related_id = get_the_ID();
                $content = esc_html(my_theme_get_excerpt_or_content(50, $related_id));
              ?>
                <div class="item">
