...
/**
 * Hero Section Layout
 * Updated: Phase 2 Sprint 2 Day 3 — design polish, section-hero class, hero-split class
 */
...
<section id="<?php echo esc_attr( $section_id ); ?>" class="section-hero <?php echo esc_attr( $section_class ); ?>">
	...
	<?php elseif ( $image_position === 'background' && $image ) : ?>
